...
/***/ function(module, exports, __webpack_require__) {
	...
	window.docs = new Vue({
		...
		components: {
			docs: _vuestrapDocsSrcComponentsDocs2['default']
		}
	});
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		"repository": {
			"type": "git",
			"url": "git+https://github.com/kzima/vuestrap-template-component.git"
		},
		"scripts": {
		...
		"license": "MIT",
		"bugs": {
			"url": "https://github.com/kzima/vuestrap-template-component/issues"
		},
		"dependencies": {
			"vue": "^1.0.10"
		},
		...
		"homepage": "https://github.com/kzima/vuestrap-template-component#readme"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _helloWorld = __webpack_require__(42);

	var _helloWorld2 = _interopRequireDefault(_helloWorld);

	exports['default'] = {
		pages: [_introduction2['default'], _helloWorld2['default']]
	};
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _snippetHtml = __webpack_require__(43);

	var _snippetHtml2 = _interopRequireDefault(_snippetHtml);

	var _helloWorldHtml = __webpack_require__(44);

	var _helloWorldHtml2 = _interopRequireDefault(_helloWorldHtml);

	var _helloWorldJson = __webpack_require__(45);

	var _helloWorldJson2 = _interopRequireDefault(_helloWorldJson);
	...
	exports['default'] = {
		route: {
			url: '/hello-world',
			name: _helloWorldJson2['default'].name,
			title: _helloWorldJson2['default'].title
		},
		template: _helloWorldHtml2['default'],
		data: function data() {
			return {
				meta: _helloWorldJson2['default'],
		...
		components: {
			'hello-world': _srcComponentsHelloWorld2['default'],
...
/***/ function(module, exports) {
	...
	module.exports = {
		"name": "hello",
		"title": "Hello World",
		"description": "Replace me with your own component.",
		"accessibility": "Some accessibility info goes here.",
		"dependencies": [
			"vuestrap/core/spinner"
		],
		"category": "components",
		"browserSupport": {
			"browsers": [
			...
			"note": "* It works in every IE version and mobile."
		},
		"options": [
			{
				"name": "bold",
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./../../../node_modules/vuestrap-theme-loader/index.js!./hello-world.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/sass-loader/index.js!./../../../node_modules/vuestrap-theme-loader/index.js!./hello-world.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".vuestrap-hello-world p {\n  color: #000;\n  font-size: 1em; }\n  .vuestrap-hello-world p.text-bold {\n    font-weight: bold; }\n  .vuestrap-hello-world p.text-sm {\n    font-size: 0.6em; }\n  .vuestrap-hello-world p.text-lg {\n    font-size: 1.6em; }\n", ""]);
